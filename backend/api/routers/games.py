...
async def list_games(
    ...
    query = sql.SQL("""
        SELECT g.school, g.opponent, g.date, g.points_for, g.points_against,
               ...
               hd_a.facemask_color, hd_a.logo, hd_a.stripe, hd_a.tags, hd_a.notes, hd_a.is_primary,
               ...
               hd_b.facemask_color, hd_b.logo, hd_b.stripe, hd_b.tags, hd_b.notes, hd_b.is_primary,
