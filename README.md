...
- `/api/v1/seasons/{season}/dates` — notable game dates for a timeline scrubber (round, week, game count, human `description`); optional `class` filter resolves 1A-4A/5A-7A's offset playoff schedules unambiguously
