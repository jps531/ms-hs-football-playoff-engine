...
COMMENT ON COLUMN region_standings.odds_first_round_home IS
  ...
  'Computed by the pipeline as first_round_home_overall / p_playoffs.';
COMMENT ON COLUMN region_standings.odds_second_round_home IS
  'p_host_given_reach probability of hosting a second-round playoff game: P(hosts R2 | reaches R2).';
COMMENT ON COLUMN region_standings.odds_quarterfinals_home IS
  'p_host_given_reach probability of hosting a quarterfinal game: P(hosts QF | reaches QF).';
