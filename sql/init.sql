...
CREATE TABLE IF NOT EXISTS region_standings (
  ...
  odds_third_round REAL NOT NULL DEFAULT 0.0,
  ...
  odds_third_round_weighted REAL NOT NULL DEFAULT 0.0,
  ...
  odds_third_round_home REAL NOT NULL DEFAULT 0.0,
  ...
  odds_third_round_home_weighted REAL NOT NULL DEFAULT 0.0,
